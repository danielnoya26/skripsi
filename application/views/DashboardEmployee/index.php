...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<script>
		...
		$('#formAttendance')
			...
			.validate({
				submitHandler: function () {
					...
					form.set("imageDataURL", imageDataURL);
		...
		function removeCameraAkses() {
			if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
			// Access the media devices
			navigator.mediaDevices.getUserMedia({ video: true })
				.then(function (stream) {
				// Store the stream object if needed
				...
				// Remove the stream from any video element
				var videoElement = document.getElementById("videoAbsen");
				if (videoElement) {
